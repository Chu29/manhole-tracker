    ...
    >
      ...
      >
        ...
        <View style={styles.brandHeader}>
          ...
          <Text style={styles.brandSubtitle}>JOIN FIELD AGENT PLATFORM</Text>
        </View>

        {/* Card Form */}
        <View style={styles.formCard}>
          <Text style={styles.cardHeaderTitle}>Technician Registration</Text>
          ...
          >
            {loading ? (
              ...
              <>
                <Text style={styles.buttonText}>Register Technician</Text>
